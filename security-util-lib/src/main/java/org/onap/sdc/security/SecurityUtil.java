...
public class SecurityUtil {
    ...
    private static final Key secKey = generateKey(KEY, ALGORITHM);
    ...
    /**
     * @param strDataToEncrypt - plain string to encrypt Encrypt the Data a. Declare / Initialize the Data. Here the data is of type String b. Convert
     *                         the Input Text to Bytes c. Encrypt the bytes using doFinal method
     */
     ...
     * @param isBase64Decoded - is data already base64 encoded&aligned to 16 bytes a. Initialize a new instance of Cipher for Decryption (normally
     *                        don't reuse the same object) b. Decrypt the cipher bytes using doFinal method
     */
