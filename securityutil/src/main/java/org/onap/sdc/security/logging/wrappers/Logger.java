...
public class Logger implements org.slf4j.Logger {
    ...
    public void invoke(String remoteHost, String targetEntity, String targetServiceName, String msg, Object... params) {

        String invocationId = UUID.randomUUID().toString();
        metric.startTimer()
            .stopTimer()
            .setRemoteHost(remoteHost)
                .setOptCustomField2(invocationId)
                .setTargetServiceName(targetServiceName)
                .setTargetEntity(targetEntity)
                .setStatusCode(ONAPLogConstants.ResponseStatus.INPROGRESS.name());
    //(MarkerFactory.getMarker("INVOKE"), LogLevel.INFO, msg, params);
        metric.log(ONAPLogConstants.Markers.INVOKE, LogLevel.INFO, msg, params);
    }

//    public void invoke(HttpResponse<String> response,  String targetServiceName, String targenEntity, String msg, Object... params) {
//
//        String invocationId = UUID.randomUUID().toString();
//        metric.startTimer()
//                .stopTimer()
//                .setRemoteHost(response.getResponse())
//                .setOptCustomField2(invocationId)
//                .setTargetServiceName(targetServiceName)
//                .setTargetEntity(targenEntity)
//                .setStatusCode("1234");
//        //(MarkerFactory.getMarker("INVOKE"), LogLevel.INFO, msg, params);
//        metric.log(MarkerFactory.getMarker("INVOKE"), LogLevel.INFO, msg, params);
//    }

    public void invokeReturn(ONAPLogConstants.ResponseStatus responseStatus, String msg, Object... params) {
        //String invocationId = UUID.randomUUID().toString();
        try {
            metric.startTimer()
                    .stopTimer()
                    .setStatusCode(responseStatus.name());
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     */
    public void error(EcompErrorSevirity errorLevel,
